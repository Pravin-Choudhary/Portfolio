...
export function About(){
    ...
    <div className="grid sm:grid-cols-3">
       ...
       <div className=" pl-0 p-2 px-6 space-y-2 col-span-2">
            ...
            <div className="text-wrap">
                <p className="text-muted-foreground dark:text-muted-foreground flex justify-center pl-0 p-2 px-5 text-sm font-normal sm:text-base">
